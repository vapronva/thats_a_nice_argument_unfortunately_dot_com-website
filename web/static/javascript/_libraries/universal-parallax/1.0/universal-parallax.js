...
const calculateHeight = function (e, t) {
  for (let a = 0; e.length > a; a++) {
    ...
    const r = windowHeight > i.height + n ? i.height + n - n / t : i.height + 2 * (o - o / t);
...
const universalParallax = function () {
  this.init = function (i) {
    ...
    for (var n = document.getElementsByClassName(i.className), e = 0; n.length > e; e++) {
      ...
      a.className += 'parallax__container', window.getComputedStyle(a.parentElement, null).getPropertyValue('position') !== 'relative' && (a.parentElement.style.position = 'relative');
      const o = n[e].dataset.parallaxImage;
      void 0 !== o && (n[e].style.backgroundImage = `url(${o})`, n[e].classList.length === 1 && n[e].classList[0] === 'parallax' && (n[e].style.backgroundRepeat = 'no-repeat', n[e].style.backgroundPosition = 'center', n[e].style.backgroundSize = 'cover'));
    }
    document.addEventListener('readystatechange', (e) => {
      let t; let
        a;
      e.target.readyState === 'complete' && (t = n, (a = i.speed) < 1 && (a = 1), calculateHeight(t, a), mobile || window.addEventListener('resize', () => {
