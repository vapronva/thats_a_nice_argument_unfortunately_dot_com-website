    ...
    universalParallax = function () {
        this.init = function (i) {
            ...
            for (var n = document.getElementsByClassName(i.className), e = 0; n.length > e; e++) {
                ...
                a.className += "parallax__container", "relative" !== window.getComputedStyle(a.parentElement, null).getPropertyValue("position") && (a.parentElement.style.position = "relative");
